...
android {
    ...
    applicationVariants.configureEach {
        ...
        variant.outputs.forEach { output ->
            ...
            // Force output name to be predictable for F-Droid (modern Flutter order: flavor-abi)
            val abiName = abi ?: "universal"
            (output as ApkVariantOutputImpl).outputFileName = "app-foss-${abiName}-release.apk"
        }
    }
}
